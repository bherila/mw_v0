...
<TABLE WIDTH=800 BORDER=0 CELLPADDING=0 CELLSPACING=0>
	<TR>
		<TD COLSPAN=9>
			<IMG SRC="images/TUI_menu_01.gif" WIDTH=800 HEIGHT=125 BORDER=0 USEMAP="#menu_01_Map"></TD>
	</TR>
	<TR>
		<TD ROWSPAN=2>
    ...
    <table border="0" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2" height="100%">
      ...
      <tr>
        ...
        <FONT FACE="Arial" SIZE="2" COLOR="#000066">
            ...
            <SPAN STYLE="font-weight: 400">, a water service line maintenance plan offered by 
        Tidewater Utilities, Inc.<br>
&nbsp;</SPAN></FONT></td>
            </td>
          </tr>
        </table>
